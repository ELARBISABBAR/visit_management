                ...
                <tr>
                    <td style="background-color: #ffffff; padding: 48px;">
                        ...
                        <p style="margin: 0 0 36px 0; font-size: 14px; font-weight: 300; line-height: 1.7; color: #5a5a52;">
                            La visite a été clôturée avec succès. Veuillez trouver ci-dessous le récapitulatif complet de cette session.
                        </p>
                            ...
                            <tr>
                                <td>
                                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                        ...
                                        <!-- Row 4: Departure + Duration -->
                                        <tr>
                                            <td width="50%" style="padding-right: 16px; vertical-align: top; border-top: 1px solid #e8e6df; padding-top: 20px;">
                                                <p style="margin: 0 0 5px 0; font-size: 10px; font-weight: 500; letter-spacing: 2px; text-transform: uppercase; color: #9c9a8e;">Départ</p>
                                                <p style="margin: 0; font-size: 14px; font-weight: 400; color: #1a1a18;">{{ optional($departureAt)?->format('d/m/Y') ?: '—' }}</p>
                                                <p style="margin: 2px 0 0 0; font-size: 13px; font-weight: 300; color: #5a5a52;">{{ optional($departureAt)?->format('H:i') }}</p>
                                            </td>
                                            <td width="50%" style="padding-left: 16px; vertical-align: top; border-top: 1px solid #e8e6df; padding-top: 20px;">
                                                <p style="margin: 0 0 5px 0; font-size: 10px; font-weight: 500; letter-spacing: 2px; text-transform: uppercase; color: #9c9a8e;">Durée de la visite</p>
                                                <p style="margin: 0; font-size: 14px; font-weight: 400; color: #1a1a18;">{{ $durationMinutes !== null ? $durationMinutes.' min' : '—' }}</p>
                                            </td>
                                        </tr>
